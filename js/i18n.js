...
const dict = {
  en: {
    ...
    manualFix: 'Manual correction',
    seedFixHint: 'Where tracking is wrong, switch to “Original” and click the climber to set the subject for that frame (applies instantly). Add as many as you need.',
    manualFixHint: 'Drag in crop view to fine-tune the framing.',
    resetSeeds: 'Reset picks',
    ...
    seedHint: '💡 Click the climber on any frame to pin the subject',
  ...
  ko: {
    ...
    manualFix: '수동 보정',
    seedFixHint: '추적이 틀린 지점에서 "원본" 뷰로 클라이머를 클릭하면 그 프레임의 주인공을 직접 지정합니다(즉시 반영). 여러 지점 지정 가능.',
    manualFixHint: '크롭 뷰에서 드래그하면 프레이밍을 미세 조정할 수 있어요.',
    resetSeeds: '주인공 선택 초기화',
    resetFraming: '프레이밍 초기화',
    ...
    seedHint: '💡 아무 프레임에서나 주인공을 클릭해 지정할 수 있어요',
