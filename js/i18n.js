...
const dict = {
  en: {
    ...
    manualFix: 'Manual reframe',
    manualFixHint: 'Drag the crop preview to reposition the framing for that moment.',
  ...
  ko: {
    ...
    manualFix: '수동 보정',
    manualFixHint: '크롭 미리보기를 드래그하면 그 구간 프레이밍을 직접 옮길 수 있어요.',
    resetFraming: '보정 초기화',
