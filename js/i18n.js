...
const dict = {
  en: {
    ...
    feat3: '9:16 · 5:4 · 1:1',
    settings: 'Settings',
    trackMethod: 'Tracking method',
    mPose: 'Pose (auto)', mClick: 'Click-track',
    methodHint: 'Click-track: tap the climber on the first frame and it follows that person’s appearance (better when they’re small or side-on).',
    clickFirst: 'Tap the climber on the first frame, then analyze.',
    quality: 'Tracking accuracy',
    qFast: 'Fast', qBalanced: 'Balanced', qAccurate: 'Accurate',
    qualityHint: 'Higher accuracy handles side-on / unusual poses better, but the model is larger and slower.',
    aspect: 'Aspect ratio',
    cropSize: 'Crop size (zoom)',
    zoomTight: 'tight', zoomWide: 'full view',
    smoothness: 'Motion smoothness',
    smoothLow: 'dynamic', smoothHigh: 'smooth',
    manualFix: 'Manual correction (move the box)',
    boxFixHint: 'Where tracking is off, move the crop box: in “Original” tap/drag to place the box directly; in “Cropped” drag to pan. Add several keyframes and the box eases between them.',
    resetFraming: 'Reset corrections',
    introZoom: 'Intro zoom (zooms in 1s after start)',
    ...
    brandingNote: 'The ClimbCrop logo is always shown.',
    difficulty: 'Grade colour',
    gymLogo: 'Gym logo (optional)',
    gymNone: 'None',
    waveHint: '👋 Tap the climbers to wave, tap the chalk bag to chalk up!',
    footerMade: 'Made for climbers',
    ...
    keyHint: '🟡 Tap a keyframe to reveal its delete button',
    deleteKey: 'Delete keyframe',
    climbStartShort: 'Climb start',
    seedHint: '💡 Drag the crop box to place the framing yourself',
    ...
    shareNoFiles: 'Direct sharing isn’t available here — the video was downloaded; share it from your files.',
  ...
  ko: {
    ...
    settings: '설정',
    trackMethod: '추적 방식',
    mPose: '포즈(자동)', mClick: '클릭 추적',
    methodHint: '클릭 추적: 첫 프레임에서 클라이머를 클릭하면 그 사람 외형을 따라갑니다(작거나 옆모습일 때 유리).',
    clickFirst: '첫 프레임에서 클라이머를 클릭한 뒤 분석을 눌러 주세요.',
    quality: '추적 정확도',
    qFast: '빠름', qBalanced: '균형', qAccurate: '정확',
    qualityHint: '정확할수록 옆모습·특이 자세를 잘 잡지만 모델이 더 크고 느려요.',
    aspect: '화면비',
    cropSize: '크롭 크기 (줌)',
    zoomTight: '타이트', zoomWide: '전체 뷰',
    smoothness: '움직임 부드러움',
    smoothLow: '다이나믹', smoothHigh: '부드럽게',
    manualFix: '수동 보정 (박스 이동)',
    boxFixHint: '추적이 틀린 지점에서 크롭 박스를 옮기세요 — "원본" 뷰는 탭/드래그로 박스를 바로 놓고, "크롭" 뷰는 드래그로 화면을 밉니다. 여러 지점을 지정하면 그 사이는 부드럽게 이어집니다.',
    resetFraming: '보정 초기화',
    introZoom: '인트로 줌 (시작 1초 뒤 확대)',
    setHere: '현재 위치로 설정',
    zoomDur: '확대 시간',
    skeleton: '자세 오버레이',
    ...
    brandingNote: 'ClimbCrop 로고는 항상 표시됩니다.',
    difficulty: '난이도 색',
    gymLogo: '암장 로고 (선택)',
    gymNone: '없음',
    waveHint: '👋 캐릭터를 누르면 인사, 초크백을 누르면 초크!',
    footerMade: '클라이머를 위해 만들었어요',
    analyze: '클라이머 분석',
    export: '영상 내보내기',
    startOver: '처음부터 다시',
    ...
    trimLabel: '시작/끝 트림',
    keyHint: '🟡 키프레임을 누르면 삭제 버튼이 떠요',
    deleteKey: '키프레임 삭제',
    climbStartShort: '등반 시작',
    seedHint: '💡 크롭 박스를 드래그해 원하는 위치로 옮길 수 있어요',
    ...
    shareNoFiles: '여기선 바로 공유가 안 돼요 — 영상을 다운로드했어요. 갤러리·파일에서 공유해 주세요.',
